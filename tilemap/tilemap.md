...
| `D``I` |    Data    | What it is |
|--------|------------|------------|
| `0``0` |  no data   | A single block. |
| `0``1` |  no data   | A structure (collection of multiple blocks). |
| `1``0` | `1111WWWW` | A horizontal line of blocks. `W` is the width. |
| `1``1` | `1111HHHH` | A vertical line of blocks. `H` is the height. |

## Why data starts with `1111`
